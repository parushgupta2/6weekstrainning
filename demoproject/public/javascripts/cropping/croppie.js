    ...
    function _updatePropertiesFromImage() {
        ...
        if (self.options.enableZoom) {
            ...
            zoomer.max = fix(maxZoom, 4);
             ...
             if(imgData.width == 300 && imgData.height == 250 && vpData.width == 300 && vpData.height == 250){
                initialZoom = 1;
             } else if(imgData.width == 336 && imgData.height == 280 && vpData.width == 336 && vpData.height == 280){
                initialZoom = 1;
             } else if(imgData.width == 728 && imgData.height == 90 && vpData.width == 728 && vpData.height == 90){
                initialZoom = 1;
             } else if(imgData.width == 300 && imgData.height == 600 && vpData.width == 300 && vpData.height == 600){
                initialZoom = 1;
             } else if(imgData.width == 320 && imgData.height == 100 && vpData.width == 320 && vpData.height == 100){
                initialZoom = 1;
             } else{
